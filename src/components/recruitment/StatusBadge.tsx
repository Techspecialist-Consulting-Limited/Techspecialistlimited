...
const STATUS_CONFIG: Record<string, { label: string; bg: string; text: string; dot: string }> = {
  ...
  assessment_flagged: { label: 'Flagged', bg: 'rgba(239, 68, 68, 0.1)', text: 'var(--status-rejected)', dot: 'var(--status-rejected)' },
  interview_scheduled: { label: 'Interview Scheduled', bg: 'rgba(69, 132, 237, 0.1)', text: 'var(--blue)', dot: 'var(--blue)' },
  hired: { label: 'Hired', bg: 'rgba(34, 197, 94, 0.1)', text: 'var(--status-approved)', dot: 'var(--status-approved)' },
