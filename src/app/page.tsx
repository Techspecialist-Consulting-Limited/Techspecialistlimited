        ...
        <div className="max-w-6xl mx-auto flex items-center gap-8 sm:gap-10 px-4 sm:px-8 md:px-16">
          ...
          <div className="flex-1 overflow-hidden" style={{ maskImage: 'linear-gradient(to right,transparent 0%,#000 8%,#000 92%,transparent 100%)', WebkitMaskImage: 'linear-gradient(to right,transparent 0%,#000 8%,#000 92%,transparent 100%)' }}>
            <div className="partners-track flex items-center gap-14 w-max animate-scroll">
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/v1772714011/vitesse-africa_hw9uhc.svg" alt="Vitesse Africa" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/t_faqimage/Nigeria_Sovereign_Investment_Authority_logo.svg_ot8hus" alt="NSIA" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/v1772714010/logo.jpg_i1jmtu.jpg" alt="Partner" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/v1772714011/International_IDEA_logo_2023.svg_v8p6ve.png" alt="International IDEA" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/v1769426792/ITF_rqhfac.jpg" alt="ITF" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/t_new/macarthur_foundation_logo_bgu5s4" alt="MacArthur Foundation" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/v1772714007/british-copy_pgm3yr.png" alt="British Council" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/t_new/images_4_luyjae" alt="FCCPC" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/t_new/images_3_n78nql" alt="NMRC" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/v1769426792/neca_doibsu.jpg" alt="NECA" /></div>
              <div className="flex items-center justify-center py-1"><img className="h-12 w-auto max-w-40 object-contain opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all" src="https://res.cloudinary.com/daqmbfctv/image/upload/t_new/imfhf10w_400x400_hl9mwd" alt="GF" /></div>
            </div>
          </div>
        </div>
      </section>
            ...
            {[
              ...
              <div key={i} className="msft-tile bg-white dark:bg-[#101827] rounded-xl p-4 text-center border border-gray-200 dark:border-white/10 hover:border-[#4584ed] hover:shadow-md transition">
                <div className="msft-tile-icon flex items-center justify-center mb-2">
                  <img src={tool.img} alt={tool.name} className="h-10 w-auto" />
                </div>
          ...
          <div className="team-featured-row">
            <div className="team-card-founder" onClick={() => (window as any).revealFounderBio?.()}>
              <div className="founder-photo" id="founderPhoto">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_3112,w_4016/NEW_CHAIR_PHOTO_gpgfga.jpg" />
              </div>
            ...
            <div className="team-card-large">
              <div className="large-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_930,w_1024/ChatGPT_Image_Mar_23_2026_12_32_54_PM_gdcoow.png" alt="Oluwagbolahan Aina" />
              </div>
            ...
            <div className="team-card-large">
              <div className="large-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_2930,w_3106/TBS_7248.jpg_ipltwe.jpg" alt="Joy Adah" />
              </div>
              <div className="large-body">
          ...
          <div className="team-secondary-row masked" id="teamSecondaryRow">
            <div className="team-card-small hidden" data-team-card="true">
              <div className="small-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_2502,w_2696/tbs_7279jpg_iwkhrb_68362b.jpg" alt="Suleman Olalomi" />
              </div>
            ...
            <div className="team-card-small hidden" data-team-card="true">
              <div className="small-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_459,w_407/team8_yingf2.png" alt="Zainab Sanni" />
              </div>
              <div className="small-body">
            ...
            <div className="team-card-small hidden" data-team-card="true">
              <div className="small-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_995,w_1024/IMG_0582_bs7gmt.png" alt="Ejike Etolue" />
              </div>
              <div className="small-body">
            ...
            <div className="team-card-small hidden" data-team-card="true">
              <div className="small-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_2206,w_2696/tbs_7297jpg_myh9kb_68362b.jpg" alt="Charles Onyeso" />
              </div>
              <div className="small-body">
            ...
            <div className="team-card-small hidden" data-team-card="true">
              <div className="small-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_1115,w_1024/ChatGPT_Image_Mar_23_2026_02_41_23_PM_cuwmuf.png" alt="Abbas Taofeeq" />
              </div>
              <div className="small-body">
            ...
            <div className="team-card-small hidden" data-team-card="true">
              <div className="small-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_1008,w_1024/tobe_twnd5m.png" alt="Praise Jacob" />
              </div>
              <div className="small-body">
            ...
            <div className="team-card-small hidden" data-team-card="true">
              <div className="small-photo">
                <img src="https://res.cloudinary.com/daqmbfctv/image/upload/c_crop,g_north_west,h_2206,w_2696/tbs_7274jpg_gmfio2_68362b.jpg" alt="Robinah Abdulaziz" />
              </div>
              <div className="small-body">
